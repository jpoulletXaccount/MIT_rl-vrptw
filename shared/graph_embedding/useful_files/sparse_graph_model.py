...
from shared.graph_embedding.useful_files.sparse_graph_task import Sparse_Graph_Task, DataFold
...
class Sparse_Graph_Model(ABC):
    ...
    def test(self, input_env):
        with self.graph.as_default():
            ...
            self.log_line("Test performed in " + str(test_time))

        return final_represenation
